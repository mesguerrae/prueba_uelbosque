                    ...
                    <div class="tab-content">
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                            <div class="row">
                                    ...
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            <form class="" id="vehiculoform" method="post">
                                                <div class="position-relative form-group"><label for="vehiculo" class="">Vehiculo</label>
                                                    <select name="vehiculo" id="vehiculo"  class="form-control">

                                                    </select>
                                                </div>
                                                <div class="position-relative form-group"><label for="material" class="">Material</label>
                                                    <select name="material" id="material" type="text" class="form-control">
                                                        <option value="ARENA">ARENA</option>
                                                        <option value="LADRILLO">LADRILLO</option>
                                                        <option value="CEMENTO">CEMENTO</option>
                                                        <option value="VIGA DE ACERO">VIGA DE ACERO</option>
                                                        <option value="PIEDRA">PIEDRA</option>
                                                    </select>
                                                </div>
                                                <div class="position-relative form-group"><label for="distancia" class="">Distancia</label><input name="distancia" id="distancia"  type="number" class="form-control"></div>
                                                <div class="position-relative form-group"><label for="peso" class="">Peso</label><input name="peso" id="peso"  type="number" class="form-control"></div>
                                ...
                                <div class="col-lg-6">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">Rutas registrados</h5>
                ...
                success: function(response)
                {
                    ...
                    if (jsonData.success == "1")
                    {
                        ...
                        for(var i = 0; i < jsonData.data.length; i++) {
                                ...
                                newText  = document.createTextNode(jsonData.data[i].vehiculo);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(2);
                                newText  = document.createTextNode(jsonData.data[i].material);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(3);
                                newText  = document.createTextNode(jsonData.data[i].distancia + " KM");
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(4);
                                newText  = document.createTextNode(jsonData.data[i].peso + " Kg");
                                newCell.appendChild(newText);
                ...
                success: function(response)
                {
                    ...
                    if (jsonData.success == "1")
                    {
                        ...
                        for(var i = 0; i < jsonData.data.length; i++) {
                            ...
                            opt.value = jsonData.data[i].placa;
                            opt.innerHTML = jsonData.data[i].placa + " - " + jsonData.data[i].conductor;
