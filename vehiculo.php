...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
    <div class="app-header header-shadow">
        <div class="app-header__logo">
            <div class="logo-srcx">Transporte</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            <form class="" id="vehiculoform" method="post">
                                                <div class="position-relative form-group"><label for="placa" class="">Placa</label><input name="placa" id="placa"  type="text" class="form-control"></div>
                                                <div class="position-relative form-group"><label for="conductor" class="">Conductor</label><input name="conductor" id="conductor" type="text" class="form-control"></div>
                                                <div class="position-relative form-group"><label for="tecnico_fecha_ini" class="">Fecha inicio Tecnicomecanica</label><input name="tecnico_fecha_ini" id="tecnico_fecha_ini" type="date" class="form-control"></div>
                                                <div class="position-relative form-group"><label for="tecnico_fecha_fin" class="">Fecha Fin Tecnicomecanica</label><input name="tecnico_fecha_fin" id="tecnico_fecha_fin" type="date" class="form-control"></div>
                                                <div class="position-relative form-group"><label for="soat_fecha_ini" class="">Fecha Inicio SOAT</label><input name="soat_fecha_ini" id="soat_fecha_ini" type="date" class="form-control"></div>
                                                <div class="position-relative form-group"><label for="soat_fecha_fin" class="">Fecha Fin SOAT</label><input name="soat_fecha_fin" id="soat_fecha_fin" type="date" class="form-control"></div>
                                                <div class="position-relative form-group"><label for="seguro_fecha_ini" class="">Fecha Inicio Poliza Seguro</label><input name="seguro_fecha_ini" id="seguro_fecha_ini" type="date" class="form-control"></div>
                                                <div class="position-relative form-group"><label for="seguro_fecha_fin" class="">Fecha Fin Poliza Seguro</label><input name="seguro_fecha_fin" id="seguro_fecha_fin" type="date" class="form-control"></div>
                                                <div class="position-relative form-group"><label for="capacidad" class="">Capacidad</label><input name="capacidad" id="capacidad" type="number" class="form-control"></div>
                                                
                                                <input class="mt-1 btn btn-primary" type="submit" name="loginBtn" id="loginBtn" value="Guardar" />
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">Vehiculos registrados</h5>
                                    <div class="table-responsive">
                                        <table class="mb-0 table" id="myTable">
                                            <thead>
                                                ...
                                                <td>PLACA</td>
                                                <td>CONDUCTOR</td>
                                                <td>FECHA INICIO TECNICOMECANICA</td>
                                                <td>FECHA FIN TECNICOMECANICA</td>
                                                <td>FECHA INICIO SOAT</td>
                                                <td>FECHA FIN SOAT</td>
                                                <td>FECHA INICIO POLIZA SEGURO</td>
                                                <td>FECHA FIN POLIZA SEGURO</td>
                                                <td>CAPACIDAD</td>
                                            </thead>
                                            <tbody>
                ...
                success: function(response)
                {
                    ...
                    if (jsonData.success == "1")
                    {
                        ...
                        for(var i = 0; i < jsonData.data.length; i++) {
                                ...
                                var newText  = document.createTextNode(jsonData.data[i].id);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(1);
                                newText  = document.createTextNode(jsonData.data[i].placa);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(2);
                                newText  = document.createTextNode(jsonData.data[i].conductor);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(3);
                                newText  = document.createTextNode(jsonData.data[i].tecnico_fecha_ini);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(4);
                                newText  = document.createTextNode(jsonData.data[i].tecnico_fecha_fin);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(5);
                                newText  = document.createTextNode(jsonData.data[i].soat_fecha_ini);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(6);
                                newText  = document.createTextNode(jsonData.data[i].sota_fecha_fin);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(7);
                                newText  = document.createTextNode(jsonData.data[i].seguro_fecha_ini);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(8);
                                newText  = document.createTextNode(jsonData.data[i].seguro_fecha_fin);
                                newCell.appendChild(newText);

                                newCell  = newRow.insertCell(9);
                                newText  = document.createTextNode(jsonData.data[i].capacidad);
                                newCell.appendChild(newText);
