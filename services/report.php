<?php
    require(dirname(__DIR__) ."/config/database.php");
        ...
        $query = "SELECT rutas.id, vehiculo, material, distancia, peso, FORMAT(((distancia/5)*(800000*peso)),2) as costo,conductor as responsable FROM rutas,vehiculo where placa = vehiculo";
             ...
             if (!$sql->execute()) {
               ...
               if (!$resultado ) {
                    ...
                    if($resultado->num_rows == 0){
                        echo json_encode(array('success' => 0 , 'error' => array( 'message' => 'No hay Rutas registradas', 'code' => '001')));
                    }else{
                        $data = array();
